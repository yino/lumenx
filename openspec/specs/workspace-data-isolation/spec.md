# workspace-data-isolation Specification

## Purpose
Define user-owned workspace isolation across application data, assets, media, browser state, retention, and database enforcement.
