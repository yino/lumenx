# ticket-accounting Specification

## Purpose
Define deterministic token-to-ticket accounting, wallet reservations, settlement, immutable ledger history, and reconciliation.
