# chinese-only-ui Specification

## Purpose
Define the mandatory Chinese-only user experience and safe Chinese-facing error behavior for cloud users and platform administrators.
