...
POLICY_SOURCE_REGISTRY: Mapping[str, PolicyAuthority] = MappingProxyType(
    {
        ...
        "short_drama_agent_enabled": PolicyAuthority.DATABASE,
        "short_drama_agent_shadow_mode": PolicyAuthority.DATABASE,
        "short_drama_agent_require_approval": PolicyAuthority.DATABASE,
        "short_drama_agent_profiles": PolicyAuthority.DATABASE,
        "short_drama_agent_max_concurrency": PolicyAuthority.DATABASE,
...
RUNTIME_POLICY_CONSUMERS: Mapping[str, str] = MappingProxyType(
    {
        ...
        "short_drama_agent_enabled": "CloudFeatureGate.require_short_drama_agent",
        "short_drama_agent_shadow_mode": "ShortDramaAgentService.create_run",
        "short_drama_agent_require_approval": "ShortDramaAgentService.create_run",
        "short_drama_agent_profiles": "CloudFeatureGate.require_short_drama_agent",
        "short_drama_agent_max_concurrency": "ShortDramaAgentService.create_run",
