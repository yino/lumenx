  ...
  return (
    <div className="flex h-full min-h-0 bg-background text-foreground">
      <aside className="hidden w-64 shrink-0 flex-col border-r border-glass-border bg-surface/45 lg:flex">
        <div className="border-b border-glass-border px-5 py-5"><p className="font-display text-lg font-semibold">LumenX 系统后台</p><p className="mt-1 text-xs text-text-muted">运营、安全与计费控制面</p></div>
